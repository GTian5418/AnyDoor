...
if (!window.Native) {
  ...
  window.__mockNative = window.Native = {
    ...
    share: () => {},
    vibrate: () => {},
    saveDonateQr: () => alert('保存到相册需要在真机上使用（预览模式）'),
    getLogs: () => '[]',
